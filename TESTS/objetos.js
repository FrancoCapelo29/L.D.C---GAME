export const objetoTest={
    C0:{
        inicial: `Caminar por este sitio es todo lo que sabes hacer, tus recuerdos no son más que fragmentos dispersos, lo que alguna vez fuistes ya no existe y los únicos recuerdos que logras recordar es caminar por un mar de llamas que devora todo lo que está a su paso.
        ...
        Tus pensamientos se detienen, nada bueno sale recordando, por eso si caminando por este lugar, un lugar donde no hay algún sentido del tiempo, donde tu existencia no es más que una anormalidad, un sitio donde solo hay un infinito sin nada, no sabes el porque caminas, no tienes ambiciones. 
    ...
    C1:{
        inicial:`palabras, palabritas, palabrotas`,
        segundo:`sonsacar al fernando la susodicha
        vacuna para el vacuno`
    }
}